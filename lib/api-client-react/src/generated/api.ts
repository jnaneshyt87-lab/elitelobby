 ...
 */
export const getTasksByStatus = async ( options?: RequestInit): Promise<StatusCount[]> => {
...
export const getGetTasksByStatusQueryKey = () => {
    return [
    `/api/dashboard/tasks-by-status`
    ] as const;
    }


export const getGetTasksByStatusQueryOptions = <TData = Awaited<ReturnType<typeof getTasksByStatus>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTasksByStatus>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetTasksByStatusQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getTasksByStatus>>> = ({ signal }) => getTasksByStatus({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getTasksByStatus>>, TError, TData> & { queryKey: QueryKey }
}

export type GetTasksByStatusQueryResult = NonNullable<Awaited<ReturnType<typeof getTasksByStatus>>>
...
export function useGetTasksByStatus<TData = Awaited<ReturnType<typeof getTasksByStatus>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTasksByStatus>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
